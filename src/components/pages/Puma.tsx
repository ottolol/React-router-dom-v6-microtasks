...
export const pumaArr: PumaItem[] = [
    ...
    {
        id: "2",
        model: 'krossovki-puma-trinity-mid-hybrid-leather',
    ...
    {
        id: "3",
        model: 'krossovki-puma-trinity-open-road',
                        ...
                        return (
                            <>
                                <Link to={`/puma/${puma.id}`} key={puma.id}>
                                    <img src={puma.picture} alt={puma.model} style={{ width: "200px", marginRight: "20px" }} />
                                </Link>
                            </>
                        )
                    })}
